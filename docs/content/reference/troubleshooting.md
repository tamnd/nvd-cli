...
Most of these come down to network reality or how nvd serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nvd rate-limits like any public site. nvd already paces
...
Where a surface is gated, nvd reads a cookie or token you supply
...
`nvd`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nvd actually did
